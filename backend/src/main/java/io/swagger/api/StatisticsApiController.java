...
public class StatisticsApiController implements StatisticsApi {
    ...
    public ResponseEntity<List<Statistic>> findStats() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Statistic>>(objectMapper.readValue("[ {\r\n  \"names\" : [ {\r\n    \"quantity\" : 23,\r\n    \"name\" : \"Peter\",\r\n    \"order_price\" : 1234.56\r\n  }, {\r\n    \"quantity\" : 23,\r\n    \"name\" : \"Peter\",\r\n    \"order_price\" : 1234.56\r\n  } ],\r\n  \"total_price\" : 12345.67,\r\n  \"total_orders\" : 53\r\n}, {\r\n  \"names\" : [ {\r\n    \"quantity\" : 23,\r\n    \"name\" : \"Peter\",\r\n    \"order_price\" : 1234.56\r\n  }, {\r\n    \"quantity\" : 23,\r\n    \"name\" : \"Peter\",\r\n    \"order_price\" : 1234.56\r\n  } ],\r\n  \"total_price\" : 12345.67,\r\n  \"total_orders\" : 53\r\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
                return new ResponseEntity<List<Statistic>>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }

        return new ResponseEntity<List<Statistic>>(HttpStatus.NOT_IMPLEMENTED);
    }
