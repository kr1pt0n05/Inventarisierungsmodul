...
public class DatabaseSeeder implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                List<Inventory> newInventories = List.of(
                                createInventory(2, "Dell Latitude 5530", "SN12345", "Büro 101",
                                                new BigDecimal("850.00"), comp2,
                                                costCenter, adminUser, List.of(tag1)),
                                createInventory(3, "HP Z24 Monitor", "SN12346", "Büro 102", new BigDecimal("240.00"),
                                                comp1,
                                                costCenter2, user1, List.of(tag2)),
                                createInventory(4, "Canon LaserJet 2300", "SN12347", "Druckerraum",
                                                new BigDecimal("410.50"), comp3,
                                                costCenter3, guestUser, List.of(tag3)),
                                createInventory(5, "iPhone 14 Pro", "SN12348", "Büro 103", new BigDecimal("1240.00"),
                                                comp4,
                                                costCenter4, adminUser, List.of(tag4)),
                                createInventory(6, "Samsung Galaxy S22", "SN12349", "F&E-Abteilung",
                                                new BigDecimal("1190.00"), comp4,
                                                costCenter4, testUser, List.of(tag4)),
                                createInventory(7, "Logitech MX Master 3", "SN12350", "Schreibtisch 7",
                                                new BigDecimal("99.99"), comp2,
                                                costCenter3, user1, List.of()),
                                createInventory(8, "ThinkPad Dock", "SN12351", "Lager", new BigDecimal("189.00"), comp1,
                                                costCenter2,
                                                guestUser, List.of()),
                                createInventory(9, "MacBook Pro M2", "SN12352", "Büro 201", new BigDecimal("1899.00"),
                                                comp3,
                                                costCenter, testUser, List.of(tag1)));

                // Setze bei zwei Inventories isDeinventoried = true
                newInventories.get(2).setIsDeinventoried(true);
                newInventories.get(7).setIsDeinventoried(true);

                inventoryRepository.saveAll(newInventories);
        }

        // Hilfsmethode
        private Inventory createInventory(Integer id, String description, String serial, String location,
                        BigDecimal price,
